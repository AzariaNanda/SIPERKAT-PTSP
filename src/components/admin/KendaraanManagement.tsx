        ...
        <Table>
          <TableHeader className="bg-slate-50/50">
            <TableRow className="hover:bg-transparent border-none">
              ...
              <TableHead className="font-black text-slate-400 text-[10px] uppercase tracking-widest">Nama Kendaraan</TableHead>
              <TableHead className="font-black text-slate-400 text-[10px] uppercase tracking-widest">No. Polisi</TableHead>
              <TableHead className="font-black text-slate-400 text-[10px] uppercase tracking-widest">Penempatan</TableHead>
            ...
            {filteredData.map((item) => (
              <TableRow key={item.id} className="border-slate-50 hover:bg-slate-50/50 transition-all">
                ...
                <TableCell>
                  ...
                  <div className="text-[9px] text-green-600 font-black uppercase tracking-widest mt-0.5">
                    Unit Siap Pakai
                  </div>
                </TableCell>
                <TableCell>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="font-black uppercase text-slate-800 tracking-tighter text-xl">
              {modalMode === 'add' ? 'TAMBAH UNIT BARU' : 'EDIT UNIT KENDARAAN'}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label className="font-black text-[10px] uppercase text-slate-500 tracking-widest">Nama Kendaraan</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="font-black text-[10px] uppercase text-slate-500 tracking-widest">Foto Kendaraan</Label>
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              onClick={handleSave}
              disabled={uploading || addKendaraan.isPending || updateKendaraan.isPending}
              className="font-black text-xs uppercase tracking-tighter shadow-xl shadow-primary/20 h-11 px-8 rounded-xl"
            >
              {uploading ? 'MENGUNGGAH...' : addKendaraan.isPending || updateKendaraan.isPending ? 'MENYIMPAN...' : 'SIMPAN DATA'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
